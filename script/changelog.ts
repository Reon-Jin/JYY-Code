...
Generates UPCOMING_CHANGELOG.md by running the jyycode changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for jyycode run (default: low)
      --quiet            Suppress jyycode command output unless it fails
