...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/jyycode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/jyycode...\n")
...
console.log("Fetching npm all-time downloads for jyycode-ai...\n")
const npmDownloads = await fetchNpmDownloads("jyycode-ai")
