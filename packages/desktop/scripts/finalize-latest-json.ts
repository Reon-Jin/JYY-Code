...
const releaseId = process.env.JYYCODE_RELEASE
if (!releaseId) throw new Error("JYYCODE_RELEASE is required")

const version = process.env.JYYCODE_VERSION
if (!version) throw new Error("JYYCODE_VERSION is required")
...
const macxTarGz = "jyycode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "jyycode-desktop-mac-arm64.app.tar.gz"
