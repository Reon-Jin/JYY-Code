import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@jyycode-ai/sdk/v2"
import { SessionTurn } from "@jyycode-ai/ui/session-turn"
import { SessionReview } from "@jyycode-ai/ui/session-review"
import { DataProvider } from "@jyycode-ai/ui/context"
import { FileComponentProvider } from "@jyycode-ai/ui/context/file"
import { WorkerPoolProvider } from "@jyycode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@jyycode-ai/ui/logo"
import { IconButton } from "@jyycode-ai/ui/icon-button"
import { ProviderIcon } from "@jyycode-ai/ui/provider-icon"
import { iife } from "@jyycode-ai/core/util/iife"
import { Binary } from "@jyycode-ai/core/util/binary"
import { NamedError } from "@jyycode-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@jyycode-ai/ui/tabs"
import { MessageNav } from "@jyycode-ai/ui/message-nav"
import { FileSSR } from "@jyycode-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@jyycode-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/jyycode-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | JYYCode</Title>
              </Show>
              <Meta name="description" content="jyycode - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/jyycode"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
