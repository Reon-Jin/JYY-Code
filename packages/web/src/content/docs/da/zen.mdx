---
title: Zen
description: Udvalgt liste over modeller leveret af JYYCode.
---
...
JYYCode Zen er en liste over testede og verificerede modeller leveret af JYYCode-teamet.

Zen fungerer som enhver anden udbyder i JYYCode. Du logger ind på JYYCode Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med JYYCode.
:::
...
JYYCode Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

JYYCode Zen fungerer som enhver anden udbyder i JYYCode.

1. Du logger ind på **<a href={console}>JYYCode Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger JYYCode Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din JYYCode-konfiguration
bruger formatet `jyycode/<model-id>`. For eksempel ville du for GPT 5.5
bruge `jyycode/gpt-5.5` i din konfiguration.
...
- DeepSeek V4 Flash Free er tilgængelig på JYYCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Super Free er tilgængelig på JYYCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på JYYCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med JYYCode også.
