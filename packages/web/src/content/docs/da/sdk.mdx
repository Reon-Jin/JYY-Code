...
Brug den til at bygge integrasjoner og kontrollere jyycode programmatisk.
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `jyycode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av jyycode, kan du oprete en klientforekomst for at koble til den:
