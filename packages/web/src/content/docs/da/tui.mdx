---
title: TUI
description: Brug af JYYCode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

JYYCode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre JYYCode starter TUI for den nuværende mappe.
...
Når du bruger JYYCode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til JYYCode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut JYYCode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `jyycode.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe JYYCode venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `jyycode.default`.
