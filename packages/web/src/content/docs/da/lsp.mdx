---
title: LSP-servere
description: JYYCode integreres med dine LSP-servere.
---

JYYCode integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

JYYCode leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `JYYCODE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når jyycode åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din jyycode-konfiguration.
