...
Opprett `.jyycode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom JYYCode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i JYYCode [config](/docs/config):
...
JYYCode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
