---
title: TUI
description: Bruke jyycode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

JYYCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre JYYCode starter TUI for gjeldende katalog.
...
Når du bruker JYYCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til JYYCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt JYYCode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `jyycode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge JYYCode venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `jyycode.default`.
