---
title: Zen
description: Utvalgt liste over modeller levert av JYYCode.
---
...
JYYCode Zen er en liste over testede og verifiserte modeller levert av JYYCode-teamet.

Zen fungerer som enhver annen leverandør i JYYCode. Du logger inn på JYYCode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med JYYCode.
:::
...
JYYCode Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

JYYCode Zen fungerer som enhver annen leverandør i JYYCode.

1. Du logger inn på **<a href={console}>JYYCode Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger JYYCode Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i JYYCode-konfigurasjonen din
bruker formatet `jyycode/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `jyycode/gpt-5.5` i konfigurasjonen din.
...
- DeepSeek V4 Flash Free er tilgjengelig på JYYCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Super Free er tilgjengelig på JYYCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på JYYCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet JYYCode Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med JYYCode også.
