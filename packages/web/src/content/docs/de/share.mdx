---
title: Teilen
description: Teile JYYCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu JYYCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht JYYCode Folgendes:
...
JYYCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt JYYCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`jyycode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du jyycode in deiner Organisation einsetzt.
