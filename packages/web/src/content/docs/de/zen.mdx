---
title: Zen
description: Kuratierte Modellliste direkt von JYYCode.
---
...
JYYCode Zen ist eine Liste von getesteten und verifizierten Modellen, die vom JYYCode-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in JYYCode. Du meldest dich bei JYYCode Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um JYYCode zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit JYYCode funktionieren.
:::
...
JYYCode Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

JYYCode Zen funktioniert wie jeder andere Provider in JYYCode.

1. Du meldest dich bei **<a href={console}>JYYCode Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst JYYCode Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner JYYCode-Konfiguration verwendet das Format `jyycode/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `jyycode/gpt-5.5` in deiner Konfiguration verwenden.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf JYYCode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Super Free ist für begrenzte Zeit auf JYYCode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf JYYCode verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben JYYCode Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit JYYCode auch jeden anderen Provider zu verwenden.
