---
title: เซน
description: รายการโมเดลที่คัดสรรโดย JYYCode
---
...
JYYCode Zen คือรายการโมเดลที่ผ่านการทดสอบและยืนยันแล้วโดยทีม JYYCode

Zen ทำงานเหมือน provider อื่น ๆ ใน JYYCode คุณล็อกอินเข้า JYYCode Zen แล้วรับ
...
:::tip
เราได้ทดสอบโมเดลและ provider ที่คัดมาแล้วกลุ่มหนึ่งซึ่งทำงานได้ดีกับ JYYCode
:::
...
JYYCode Zen คือ AI gateway ที่ให้คุณเข้าถึงโมเดลเหล่านี้

---

## วิธีการทำงาน

JYYCode Zen ทำงานเหมือน provider อื่น ๆ ใน JYYCode

1. คุณลงชื่อเข้าใช้ **<a href={console}>JYYCode Zen</a>** เพิ่มรายละเอียดการเรียกเก็บเงิน แล้วคัดลอก API key ของคุณ
2. รันคำสั่ง `/connect` ใน TUI เลือก JYYCode Zen แล้ววาง API key ของคุณ
...
[model id](/docs/config/#models) ใน JYYCode config ของคุณใช้รูปแบบ `jyycode/<model-id>` ตัวอย่างเช่น สำหรับ GPT 5.5 คุณจะใช้ `jyycode/gpt-5.5` ใน config ของคุณ
...
- DeepSeek V4 Flash Free เปิดให้ใช้บน JYYCode ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- Nemotron 3 Super Free เปิดให้ใช้บน JYYCode ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- Big Pickle เป็น stealth model ที่ใช้งานฟรีบน JYYCode ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
...
เราสร้าง JYYCode Zen ขึ้นมาเพื่อ:
...
4. ทำให้เกิด **no lock-in** โดยให้คุณใช้มันร่วมกับ coding agent อื่น ๆ ได้ และยังเปิดให้คุณใช้ provider อื่น ๆ กับ JYYCode ได้เสมอ
