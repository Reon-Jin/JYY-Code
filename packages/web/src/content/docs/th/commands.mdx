...
สร้าง `.jyycode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ JYYCode:
...
- ระดับผู้ใช้ (Global): `~/.config/jyycode/commands/`
- ระดับโปรเจ็กต์: `.jyycode/commands/`
...
JYYCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
