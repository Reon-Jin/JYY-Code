---
title: Zen
description: Lista selecionada de modelos fornecidos pelo JYYCode.
---
...
O JYYCode Zen é uma lista de modelos testados e verificados fornecidos pela equipe do JYYCode.

O Zen funciona como qualquer outro provedor no JYYCode. Você faz login no JYYCode Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o JYYCode.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o JYYCode.
:::
...
O JYYCode Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O JYYCode Zen funciona como qualquer outro provedor no JYYCode.

1. Você faz login no **<a href={console}>JYYCode Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona JYYCode Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do JYYCode usa o formato `jyycode/<model-id>`. Por exemplo, para GPT 5.5, você usaria `jyycode/gpt-5.5` na sua configuração.
...
- DeepSeek V4 Flash Free está disponível no JYYCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Super Free está disponível no JYYCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no JYYCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o JYYCode também.
