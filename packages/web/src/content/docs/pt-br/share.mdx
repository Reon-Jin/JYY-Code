---
title: Compartilhar
description: Compartilhe suas conversas do jyycode.
---

O recurso de compartilhamento do jyycode permite que você crie links públicos para suas conversas do jyycode, para que você possa colaborar com colegas de equipe ou obter ajuda de outros.
...
Quando você compartilha uma conversa, o jyycode:
...
O jyycode suporta três modos de compartilhamento que controlam como as conversas são compartilhadas:

---

### Manual (padrão)

Por padrão, o jyycode usa o modo de compartilhamento manual. As sessões não são compartilhadas automaticamente, mas você pode compartilhá-las manualmente usando o comando `/share`:
...
Para impor isso em sua equipe para um determinado projeto, adicione-o ao `jyycode.json` em seu projeto e faça o check-in no Git.
...
[Saiba mais](/docs/enterprise) sobre como usar o jyycode em sua organização.
