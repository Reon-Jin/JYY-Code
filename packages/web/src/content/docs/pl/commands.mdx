...
Utwórz `.jyycode/commands/test.md`:
...
Możesz zdefiniować polecenia w `jyycode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji jyycode:
...
- Globalnie: `~/.config/jyycode/commands/`
- Na projekt: `.jyycode/commands/`
...
jyycode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
