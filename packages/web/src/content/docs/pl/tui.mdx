---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala jyycode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

jyycode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie jyycode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI jyycode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do jyycode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij jyycode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `jyycode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo JYYCode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `jyycode.default`.
