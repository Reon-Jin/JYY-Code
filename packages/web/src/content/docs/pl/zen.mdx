---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez JYYCode.
---
...
JYYCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół JYYCode.

Zen działa jak każdy inny dostawca w JYYCode. Logujesz się do JYYCode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z JYYCode.
:::
...
JYYCode Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

JYYCode Zen działa jak każdy inny dostawca w JYYCode.

1. Logujesz się do **<a href={console}>JYYCode Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz JYYCode Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji JYYCode używa formatu
`jyycode/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`jyycode/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w JYYCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Super Free jest dostępny w JYYCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w JYYCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w JYYCode także dowolnego innego dostawcy.
