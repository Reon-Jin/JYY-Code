---
title: Share
description: Share your JYYCode conversations.
---

JYYCode's share feature allows you to create public links to your JYYCode conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, JYYCode:
...
JYYCode supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, JYYCode uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `jyycode.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using jyycode in your organization.
