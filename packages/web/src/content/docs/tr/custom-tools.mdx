---
title: Özel Araçlar
description: LLM'un jyycode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. jyycode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.jyycode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/jyycode/tools/` içine yerleştirerek.
