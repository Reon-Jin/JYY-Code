...
Puoi aggiungere comandi personalizzati tramite la config di JYYCode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di JYYCode:
...
- Globale: `~/.config/jyycode/commands/`
- Per progetto: `.jyycode/commands/`
...
jyycode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
