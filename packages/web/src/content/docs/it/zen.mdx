---
title: Zen
description: Lista curata di modelli fornita da JYYCode.
---
...
JYYCode Zen è un elenco di modelli testati e verificati forniti dal team di JYYCode.

Zen funziona come qualsiasi altro provider in JYYCode. Accedi a JYYCode Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con JYYCode.
:::
...
JYYCode Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

JYYCode Zen funziona come qualsiasi altro provider in JYYCode.

1. Accedi a **<a href={console}>JYYCode Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona JYYCode Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di JYYCode
usa il formato `jyycode/<model-id>`. Per esempio, per GPT 5.5, useresti
`jyycode/gpt-5.5` nella tua config.
...
- DeepSeek V4 Flash Free è disponibile su JYYCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Super Free è disponibile su JYYCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su JYYCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato JYYCode Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con JYYCode.
