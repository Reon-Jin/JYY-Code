---
title: Zen
description: Kurirana lista modela koje nudi JYYCode.
---
...
JYYCode Zen je lista testiranih i provjerenih modela koje pruža JYYCode tim.

Zen radi kao i svaki drugi provajder u JYYCode. Prijavite se na JYYCode Zen i
preuzmete svoj API ključ. To je **potpuno opcionalno** i ne morate ga koristiti
da biste koristili JYYCode.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s JYYCode.
:::
...
JYYCode Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

JYYCode Zen radi kao i svaki drugi provajder u JYYCode.

1. Prijavite se na **<a href={console}>JYYCode Zen</a>**, dodajte podatke za
   naplatu i kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI, izaberite JYYCode Zen i zalijepite svoj API ključ.
...
[model id](/docs/config/#models) u vašoj JYYCode konfiguraciji koristi format
`jyycode/<model-id>`. Na primjer, za GPT 5.5 u konfiguraciji biste
koristili `jyycode/gpt-5.5`.
...
- DeepSeek V4 Flash Free je dostupan na JYYCode ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3 Super Free je dostupan na JYYCode ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Big Pickle je stealth model koji je besplatan na JYYCode ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
...
4. Obezbijedimo **bez lock-ina** time što vam omogućavamo da ga koristite s bilo kojim drugim coding agentom. I da vam uvijek omogućimo da koristite bilo koji drugi provajder i u JYYCode.
