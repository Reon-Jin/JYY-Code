...
Kreiraj `.jyycode/commands/test.md`:
...
Možete dodati prilagođene komande kroz JYYCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom JYYCode [config](/docs/config):
...
- Globalno: `~/.config/jyycode/commands/`
- Po projektu: `.jyycode/commands/`
...
JYYCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
