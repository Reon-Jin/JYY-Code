---
title: TUI
description: Korištenje korisničkog interfejsa JYYCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

JYYCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje JYYCode pokreće TUI za trenutni direktorij.
...
Kada koristite JYYCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u JYYCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz JYYCode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `jyycode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo JYYCode čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `jyycode.default`.
