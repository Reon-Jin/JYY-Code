...
Crear `.jyycode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración JYYCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su JYYCode [config](/docs/config):
...
jyycode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
