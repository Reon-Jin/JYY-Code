...
import { IconJyycode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "jyycode/session/message-v2"
import type { Message } from "jyycode/session/message"
import type { Session } from "jyycode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.jyycode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.jyycode_name}>
                    <IconJyycode width={16} height={16} />
                  </div>
