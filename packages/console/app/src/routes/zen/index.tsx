...
import compareVideo from "../../asset/lander/jyycode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/jyycode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="jyycode:auth" content={loggedin() ? "true" : "false"} />
