...
import { and, Database, eq, isNull, lt, or, sql } from "@jyycode-ai/console-core/drizzle/index.js"
import { KeyTable } from "@jyycode-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@jyycode-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@jyycode-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@jyycode-ai/console-core/util/date.js"
import { Identifier } from "@jyycode-ai/console-core/identifier.js"
import { Billing } from "@jyycode-ai/console-core/billing.js"
import { Actor } from "@jyycode-ai/console-core/actor.js"
import { WorkspaceTable } from "@jyycode-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@jyycode-ai/console-core/model.js"
import { Subscription } from "@jyycode-ai/console-core/subscription.js"
import { BlackData } from "@jyycode-ai/console-core/black.js"
import { UserTable } from "@jyycode-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@jyycode-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@jyycode-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@jyycode-ai/console-core/lite.js"
import { Resource } from "@jyycode-ai/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-jyycode-session") ?? ""
    const requestId = input.request.headers.get("x-jyycode-request") ?? ""
    const ocClient = input.request.headers.get("x-jyycode-client") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-jyycode-request")
          headers.delete("x-jyycode-session")
          headers.delete("x-jyycode-project")
          headers.delete("x-jyycode-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://jyycode.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://jyycode.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://jyycode.ai/workspace/${authInfo.workspaceID}/members`
