...
import desktopAppIcon from "../../asset/lander/jyycode-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://jyycode.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>jyycode.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g jyycode-ai")}>
                <code>
                  npm i -g <strong>jyycode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g jyycode-ai")}>
                <code>
                  bun add -g <strong>jyycode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/jyycode")}>
                <code>
                  brew install <strong>anomalyco/tap/jyycode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S jyycode")}>
                <code>
                  paru -S <strong>jyycode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask jyycode-desktop")}>
                <code>
                  brew install --cask <strong>jyycode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
