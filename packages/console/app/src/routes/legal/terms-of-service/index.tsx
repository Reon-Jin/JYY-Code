...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>JYYCode | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="JYYCode terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to JYYCode. Please read on to learn the rules and restrictions that govern your use of
                JYYCode&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("JYYCode," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://jyycode.ai/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-jyycode">What is JYYCode?</h2>
              <p>
                JYYCode is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the JYYCode Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, JYYCode enables you to
              ...
              <p>
                ...
                our site located at jyycode.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                JYYCode takes the privacy of its users very seriously. For the current JYYCode Privacy Policy, please
                click here{" "}
                <a href="https://jyycode.ai/legal/privacy-policy">https://jyycode.ai/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using JYYCode?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by JYYCode;
                </li>
                <li>
              ...
              <p>
                If you use JYYCode with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                JYYCode. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                JYYCode has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-jyycode-ever-change-the-services">Will JYYCode ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://jyycode.ai/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://jyycode.ai/auth">https://jyycode.ai/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://jyycode.ai/legal/privacy-policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                JYYCode is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. JYYCode has the sole right to decide whether you are
              ...
              <p>
                JYYCode and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (JYYCode and all such
                parties together, the "JYYCode Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the JYYCode Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The JYYCode Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY JYYCODE (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                JYYCODE PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO JYYCODE IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the JYYCode Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without JYYCode's prior written
              ...
              <p>
                ...
                disputes and claims with JYYCode and limits the manner in which you can seek relief from JYYCode. Both
                you and JYYCode acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, JYYCode's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. JYYCode will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. JYYCode will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or JYYCode may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND JYYCODE WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and JYYCode are instead choosing to have claims and disputes resolved by
                ...
                you and JYYCode over whether to vacate or enforce an arbitration award, YOU AND JYYCODE WAIVE ALL
              ...
              <p>
                ...
                JYYCode is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or JYYCode to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and JYYCode agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the JYYCode may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and JYYCode agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and JYYCode, and
                ...
                are not an employee, agent, partner, or joint venture of JYYCode, and you do not have any authority of
                any kind to bind JYYCode in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and JYYCode
