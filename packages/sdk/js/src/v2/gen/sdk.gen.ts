...
import type {
  ...
  SessionTerminateErrors,
  SessionTerminateResponses,
  SessionTodoErrors,
...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new JyycodeClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the JYYCode system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the JYYCode system.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global JYYCode configuration settings and preferences.
   */
   ...
   *
   * Update global JYYCode configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the JYYCode server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the JYYCode system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all JYYCode instances, releasing all resources.
   */
   ...
   * Upgrade jyycode
   *
   * Upgrade jyycode to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current JYYCode configuration settings and preferences.
   */
   ...
   *
   * Update JYYCode configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current JYYCode instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the JYYCode system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with JYYCode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that JYYCode is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by JYYCode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all JYYCode sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new JYYCode session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific JYYCode session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
  ...
  /**
   * Terminate a plan child session
   *
   * Stop a running plan child assignment and notify the parent session through its Inbox.
   */
  public terminate<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<SessionTerminateResponses, SessionTerminateErrors, ThrowOnError>({
...
export class JyycodeClient extends HeyApiClient {
  ...
  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    JyycodeClient.__registry.set(this, args?.key)
  }
