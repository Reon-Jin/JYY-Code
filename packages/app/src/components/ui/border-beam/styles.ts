...
export const colorPalettes = {
  ...
  jyy: {
    border: [
      { color: 'rgb(71, 90, 116)', pos: '33% -7.4%', size: '70px 40px' },
      { color: 'rgb(58, 74, 96)', pos: '12% -5%', size: '60px 35px' },
      { color: 'rgb(43, 46, 51)', pos: '2.1% 68.3%', size: '40px 70px' },
      { color: 'rgb(104, 106, 111)', pos: '2.1% 68.3%', size: '20px 35px' },
      { color: 'rgb(33, 36, 40)', pos: '74.4% 100%', size: '180px 32px' },
      { color: 'rgb(71, 90, 116)', pos: '55% 100%', size: '85px 26px' },
      { color: 'rgb(43, 46, 51)', pos: '93.9% 0%', size: '74px 32px' },
      { color: 'rgb(58, 74, 96)', pos: '100% 27.1%', size: '26px 42px' },
      { color: 'rgb(33, 36, 40)', pos: '100% 27.1%', size: '52px 48px' },
    ],
    spike: { primary: 'rgb(71, 90, 116)', secondary: 'rgba(33, 36, 40, 0.98)' },
    spikeLt: { primary: 'rgb(58, 74, 96)', secondary: 'rgb(43, 46, 51)' },
  },
};
...
export const smallColorPalettes = {
  ...
  jyy: {
    border: [
      { color: 'rgb(71, 90, 116)', pos: '2% 68%', size: '9px 18px' },
      { color: 'rgb(58, 74, 96)', pos: '2% 68%', size: '4px 8px' },
      { color: 'rgb(43, 46, 51)', pos: '72% -3%', size: '59px 9px' },
      { color: 'rgb(33, 36, 40)', pos: '74% 100%', size: '42px 7px' },
      { color: 'rgb(104, 106, 111)', pos: '100% 27%', size: '10px 17px' },
      { color: 'rgb(71, 90, 116)', pos: '100% 27%', size: '10px 18px' },
      { color: 'rgb(43, 46, 51)', pos: '100% 27%', size: '5px 10px' },
      { color: 'rgb(33, 36, 40)', pos: '100% 27%', size: '11px 12px' },
    ],
    inner: [
      { color: 'rgba(71, 90, 116, 0.5)', pos: '2% 68%', size: '9px 18px' },
      { color: 'rgba(58, 74, 96, 0.45)', pos: '2% 68%', size: '4px 8px' },
      { color: 'rgba(43, 46, 51, 0.35)', pos: '72% -3%', size: '59px 9px' },
      { color: 'rgba(33, 36, 40, 0.35)', pos: '74% 100%', size: '42px 7px' },
      { color: 'rgba(104, 106, 111, 0.3)', pos: '100% 27%', size: '10px 17px' },
      { color: 'rgba(71, 90, 116, 0.4)', pos: '100% 27%', size: '10px 18px' },
      { color: 'rgba(43, 46, 51, 0.3)', pos: '100% 27%', size: '5px 10px' },
      { color: 'rgba(33, 36, 40, 0.3)', pos: '100% 27%', size: '11px 12px' },
    ],
  },
};
...
export const lineColorPalettes = {
  ...
  jyy: {
    dark: [
      { color: 'rgb(71, 90, 116)', sizeW: 36, sizeH: 36, offsetX: 0, offsetY: 2 },
      { color: 'rgb(58, 74, 96)', sizeW: 30, sizeH: 32, offsetX: 39, offsetY: 0 },
      { color: 'rgb(43, 46, 51)', sizeW: 33, sizeH: 28, offsetX: -36, offsetY: 2 },
      { color: 'rgb(104, 106, 111)', sizeW: 29, sizeH: 34, offsetX: -54, offsetY: 0 },
      { color: 'rgb(33, 36, 40)', sizeW: 27, sizeH: 30, offsetX: 51, offsetY: -1 },
      { color: 'rgb(71, 90, 116)', sizeW: 36, sizeH: 24, offsetX: 21, offsetY: 1 },
      { color: 'rgb(58, 74, 96)', sizeW: 30, sizeH: 22, offsetX: -21, offsetY: 0 },
      { color: 'rgb(43, 46, 51)', sizeW: 25, sizeH: 28, offsetX: 66, offsetY: 1 },
      { color: 'rgb(33, 36, 40)', sizeW: 23, sizeH: 30, offsetX: -66, offsetY: -1 },
    ],
    light: [
      { color: 'rgb(58, 74, 96)', sizeW: 45, sizeH: 36, offsetX: 0, offsetY: 2 },
      { color: 'rgb(71, 90, 116)', sizeW: 35, sizeH: 32, offsetX: 65, offsetY: 0 },
      { color: 'rgb(43, 46, 51)', sizeW: 40, sizeH: 28, offsetX: -60, offsetY: 2 },
      { color: 'rgb(33, 36, 40)', sizeW: 35, sizeH: 34, offsetX: -90, offsetY: 0 },
      { color: 'rgb(104, 106, 111)', sizeW: 38, sizeH: 30, offsetX: 85, offsetY: -1 },
      { color: 'rgb(58, 74, 96)', sizeW: 50, sizeH: 24, offsetX: 35, offsetY: 1 },
      { color: 'rgb(71, 90, 116)', sizeW: 40, sizeH: 22, offsetX: -35, offsetY: 0 },
      { color: 'rgb(43, 46, 51)', sizeW: 35, sizeH: 28, offsetX: 110, offsetY: 1 },
      { color: 'rgb(33, 36, 40)', sizeW: 30, sizeH: 30, offsetX: -110, offsetY: -1 },
    ],
  },
};
...
export const lineInnerGradientData = {
  ...
  jyy: [
    { color: 'rgba(71, 90, 116, 0.48)', sizeW: 33, sizeH: 30, offsetX: 0, offsetY: 0 },
    { color: 'rgba(58, 74, 96, 0.42)', sizeW: 24, sizeH: 26, offsetX: 39, offsetY: -3 },
    { color: 'rgba(43, 46, 51, 0.48)', sizeW: 27, sizeH: 24, offsetX: -36, offsetY: 0 },
    { color: 'rgba(104, 106, 111, 0.42)', sizeW: 23, sizeH: 28, offsetX: -54, offsetY: -2 },
    { color: 'rgba(33, 36, 40, 0.50)', sizeW: 24, sizeH: 24, offsetX: 51, offsetY: -1 },
    { color: 'rgba(71, 90, 116, 0.45)', sizeW: 30, sizeH: 20, offsetX: 21, offsetY: 0 },
    { color: 'rgba(58, 74, 96, 0.40)', sizeW: 25, sizeH: 18, offsetX: -21, offsetY: -2 },
    { color: 'rgba(43, 46, 51, 0.45)', sizeW: 21, sizeH: 24, offsetX: 66, offsetY: 0 },
    { color: 'rgba(33, 36, 40, 0.52)', sizeW: 18, sizeH: 26, offsetX: -66, offsetY: -1 },
  ],
};
...
export const lineBloomColors = {
  ...
  jyy: {
    dark: {
      spikes: [
        { color1: 'rgb(71, 90, 116)', color2: 'rgba(71, 90, 116, 1)' },
        { color1: 'rgba(58, 74, 96, 0.59)', color2: 'rgba(58, 74, 96, 0.29)' },
        { color1: 'rgb(43, 46, 51)', color2: 'rgba(43, 46, 51, 1)' },
        { color1: 'rgba(104, 106, 111, 0.91)', color2: 'rgba(104, 106, 111, 0.45)' },
        { color1: 'rgb(33, 36, 40)', color2: 'rgba(33, 36, 40, 1)' },
      ],
    },
    light: {
      spikes: [
        { color1: 'rgb(58, 74, 96)', color2: 'rgba(58, 74, 96, 0.8)' },
        { color1: 'rgba(43, 46, 51, 0.7)', color2: 'rgba(43, 46, 51, 0.46)' },
        { color1: 'rgb(71, 90, 116)', color2: 'rgba(71, 90, 116, 0.82)' },
        { color1: 'rgba(104, 106, 111, 0.7)', color2: 'rgba(104, 106, 111, 0.46)' },
        { color1: 'rgb(33, 36, 40)', color2: 'rgba(33, 36, 40, 0.78)' },
      ],
    },
  },
};
...
function generateBorderVariantCSS(options: GenerateStylesOptions): string {
  ...
  // Mono variant gets 50% lower opacity
  const monoOpacityMultiplier = colorVariant === 'mono' ? 0.5 : 1.0;
  // JYYCode palette: dark slate/ink needs a stronger stroke to stay visible
  // on the light paper surface.
  const jyyOpacityMultiplier = colorVariant === 'jyy' && theme === 'light' ? 2.5 : 1;
  const jyyInnerMultiplier = colorVariant === 'jyy' && theme === 'light' ? 1.5 : 1;
  const finalStrokeOpacity = strokeOpacity * monoOpacityMultiplier * jyyOpacityMultiplier;
  const finalInnerOpacity = innerOpacity * monoOpacityMultiplier * jyyInnerMultiplier;
  const finalBloomOpacity = bloomOpacity * monoOpacityMultiplier;
