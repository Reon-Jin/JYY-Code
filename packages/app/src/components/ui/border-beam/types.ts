 ...
 */
export type BorderBeamColorVariant = "colorful" | "mono" | "ocean" | "sunset" | "jyy"
...
/**
 * Props for the Solid port of the BorderBeam component
 */
export interface BorderBeamProps {
  ...
  /**
   * Callback forwarded from the wrapper's animationend event
   */
   ...
   */
  ref?: ((element: HTMLDivElement) => void) | { current: HTMLDivElement | undefined }
}
