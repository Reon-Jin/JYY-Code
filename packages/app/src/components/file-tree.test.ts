...
beforeAll(async () => {
  ...
  mock.module("@jyycode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@jyycode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@jyycode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@jyycode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
