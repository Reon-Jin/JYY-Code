...
import { Tooltip, TooltipKeybind } from "@jyycode-ai/ui/tooltip"
import { useTheme } from "@jyycode-ai/ui/theme/context"
import { IconButtonV2 } from "@jyycode-ai/ui/v2/components/icon-button-v2.jsx"
import { Icon as IconV2 } from "@jyycode-ai/ui/v2/components/icon.jsx"
...
import { base64Encode } from "@jyycode-ai/core/util/encode"
import { Avatar as AvatarV2 } from "@jyycode-ai/ui/v2/components/avatar-v2.jsx"
...
const USE_V2_TITLEBAR = import.meta.env.VITE_JYYCODE_CHANNEL !== "prod"
...
export function Titlebar(props: { update?: TitlebarUpdate }) {
  ...
  const nav = createMemo(() => import.meta.env.VITE_JYYCODE_CHANNEL !== "beta" || settings.general.showNavigation())
        ...
        <Match when>
          ...
          >
              ...
              <div class="flex items-center gap-1 shrink-0">
                ...
                <div class="hidden xl:flex items-center shrink-0">
                  ...
                  >
                    ...
                    <div id="jyycode-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" />
                    <ChannelIndicator />
                  </div>
                </div>
              </div>
            ...
            <div
              ...
              onMouseDown={drag}
            >
              <div id="jyycode-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
              <Show when={windows()}>
...
function ChannelIndicator() {
  return (
    <>
      {["beta", "dev"].includes(import.meta.env.VITE_JYYCODE_CHANNEL) && (
        <div class="bg-icon-interactive-base text-[#FFF] font-medium px-2 rounded-sm uppercase font-mono">
          {import.meta.env.VITE_JYYCODE_CHANNEL.toUpperCase()}
        </div>
      )}
    </>
  )
