import { AppIcon } from "@jyycode-ai/ui/app-icon"
...
import { Keybind } from "@jyycode-ai/ui/keybind"
...
export function SessionHeader() {
  ...
  const isDesktopBeta = platform.platform === "desktop" && import.meta.env.VITE_JYYCODE_CHANNEL === "beta"
  ...
  onMount(() => {
    setCenterMount(document.getElementById("jyycode-titlebar-center"))
    setRightMount(document.getElementById("jyycode-titlebar-right"))
  })
