import type { Project, UserMessage } from "@jyycode-ai/sdk/v2"
...
import { createAutoScroll } from "@jyycode-ai/ui/hooks"
import { previewSelectedLines } from "@jyycode-ai/ui/pierre/selection-bridge"
import { Button } from "@jyycode-ai/ui/button"
import { showToast } from "@jyycode-ai/ui/toast"
import { checksum } from "@jyycode-ai/core/util/encode"
...
const USE_NEW_SESSION_DESIGN = import.meta.env.VITE_JYYCODE_CHANNEL !== "prod"
...
export default function Page() {
  ...
  const isV2NewSessionPage = () =>
    shouldUseV2NewSessionPage({ channel: import.meta.env.VITE_JYYCODE_CHANNEL, sessionID: params.id })
