...
import { ResizeHandle } from "@jyycode-ai/ui/resize-handle"
import { Button } from "@jyycode-ai/ui/button"
import { IconButton } from "@jyycode-ai/ui/icon-button"
import { Tooltip } from "@jyycode-ai/ui/tooltip"
import { DropdownMenu } from "@jyycode-ai/ui/dropdown-menu"
import { Dialog } from "@jyycode-ai/ui/dialog"
import { getFilename } from "@jyycode-ai/core/util/path"
import { Session, type Message } from "@jyycode-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@jyycode-ai/ui/toast"
...
import { retry } from "@jyycode-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@jyycode-ai/ui/theme/context"
...
const USE_NEW_DESIGN = import.meta.env.VITE_JYYCODE_CHANNEL !== "prod"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://jyycode.ai/desktop-feedback")}
      renderPanel={() =>
