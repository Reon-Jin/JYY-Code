...
const USE_HOME_DESIGN = import.meta.env.VITE_JYYCODE_CHANNEL !== "prod"
  ...
  return (
    <div class="mx-auto grid w-full h-full max-w-[1080px] gap-8 px-6 pb-16 lg:grid-cols-[280px_minmax(0,720px)]">
      <HomeProjectColumn
        ...
        openHelp={() => platform.openLink("https://jyycode.ai/desktop-feedback")}
        language={language}
      />
