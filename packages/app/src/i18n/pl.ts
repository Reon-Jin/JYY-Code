export const dict = {
  ...
  "dialog.provider.jyycode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.jyycode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.jyycodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez JYYCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w JYYCode.",
  ...
  "provider.connect.jyycodeZen.line1":
    "JYYCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.jyycodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.jyycodeZen.visit.link": "jyycode.ai/zen",
  "provider.connect.jyycodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w JYYCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w JYYCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w jyycode.json",
  ...
  "dialog.server.description": "Przełącz serwer JYYCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja JYYCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu JYYCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (jyycode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "JYYCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla JYYCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd JYYCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy JYYCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw JYYCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania JYYCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji JYYCode.",
