export const dict = {
  ...
  "command.agent.multiAgent.enable": "Enable Multi-Agent",
  "command.agent.multiAgent.disable": "Disable Multi-Agent",
  "command.agent.multiAgent.description": "Toggle Multi-Agent mode for the next prompt",
  ...
  "dialog.provider.jyycode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.jyycode.tagline": "Reliable optimized models",
  "dialog.provider.jyycodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by JYYCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in JYYCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.jyycodeZen.line1":
    "JYYCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.jyycodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.jyycodeZen.visit.prefix": "Visit ",
  "provider.connect.jyycodeZen.visit.link": "jyycode.ai/zen",
  "provider.connect.jyycodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in JYYCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in JYYCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in jyycode.json",
  ...
  "dialog.server.description": "Switch which JYYCode server this app connects to.",
  ...
  "toast.update.description": "A new version of JYYCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the JYYCode team",
  ...
  "error.chain.checkConfig": "Check your config (jyycode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, JYYCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "JYYCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "JYYCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the JYYCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for JYYCode",
  ...
  "settings.general.row.appearance.description": "Customise how JYYCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether JYYCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how JYYCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when JYYCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of JYYCode.",
