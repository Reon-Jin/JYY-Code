...
export const dict = {
  ...
  "dialog.provider.jyycode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.jyycode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.jyycodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av JYYCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i JYYCode.",
  ...
  "provider.connect.jyycodeZen.line1":
    "JYYCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.jyycodeZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.jyycodeZen.visit.prefix": "Besøk ",
  "provider.connect.jyycodeZen.visit.link": "jyycode.ai/zen",
  "provider.connect.jyycodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i JYYCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i JYYCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i jyycode.json",
  ...
  "dialog.server.description": "Bytt hvilken JYYCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av JYYCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til JYYCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (jyycode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at JYYCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "JYYCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør JYYCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for JYYCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan JYYCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om JYYCode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan JYYCode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når JYYCode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av JYYCode.",
