...
describe("projectAgentClusterState", () => {
  ...
  it("keeps a planning run visible before tasks exist", () => {
    ...
    expect(snapshot.runs[0]).toMatchObject({ id: "run_1", status: "planning", statusLabel: "Planning" })
  ...
  it.each([
    ...
    ["revising", "running", "Revising"],
    ["submitted", "review", "Submitted"],
    ["reviewing", "review", "Reviewing"],
    ["revision_requested", "review", "Revision requested"],
