...
> = {
  planned: { tone: "queued", label: "Planned" },
  queued: { tone: "queued", label: "Queued" },
  running: { tone: "running", label: "Running" },
  revising: { tone: "running", label: "Revising" },
  submitted: { tone: "review", label: "Submitted" },
  reviewing: { tone: "review", label: "Reviewing" },
  revision_requested: { tone: "review", label: "Revision requested" },
  accepted: { tone: "done", label: "Accepted" },
  failed: { tone: "failed", label: "Failed" },
  cancelled: { tone: "failed", label: "Cancelled" },
}
