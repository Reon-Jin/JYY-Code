    ...
    <section class="todo-panel" data-collapsed={props.collapsed ? "true" : "false"} aria-labelledby="todo-panel-title">
      ...
      <Show when={!props.collapsed}>
        <div class="todo-panel__body">
          <Show when={props.sessionID} fallback={<p class="todo-panel__empty">创建或选择 Session 后显示步骤</p>}>
            <Show
              when={!props.loading}
              fallback={
            ...
            >
              ...
              >
                <Show when={todos().length > 0} fallback={<p class="todo-panel__empty">当前 Session 暂无步骤</p>}>
