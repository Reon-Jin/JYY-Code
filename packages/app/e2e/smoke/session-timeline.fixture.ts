...
const directory = "C:/JYYCode/SmokeProject"
const projectID = "proj_smoke_timeline"
const model = { providerID: "jyycode", modelID: "claude-opus-4-6", variant: "max" }
...
export const fixture = {
  ...
  provider: {
    ...
    connected: ["jyycode"],
    default: { providerID: "jyycode", modelID: "claude-opus-4-6" },
  },
  sessions: [
    {
      id: sourceID,
