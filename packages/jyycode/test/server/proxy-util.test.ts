...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips jyycode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-jyycode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-jyycode-directory")).toBeNull()
      expect(result.get("x-jyycode-workspace")).toBeNull()
