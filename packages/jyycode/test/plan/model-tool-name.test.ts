...
import { requiredPlanTool, retainOnlyTool, toolNameForModel } from "../../src/session/tools"
...
describe("model-facing plan tool names", () => {
  ...
  it("forces multi-agent roots to create a missing plan instead of replying with JSON", () => {
