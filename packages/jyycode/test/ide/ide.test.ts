...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders JYYCODE_CALLER", () => {
    process.env["JYYCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode JYYCODE_CALLER", () => {
    process.env["JYYCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown JYYCODE_CALLER", () => {
    process.env["JYYCODE_CALLER"] = "unknown"
