...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/jyycode.git")).toEqual({ owner: "sst", repo: "jyycode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/jyycode")).toEqual({ owner: "sst", repo: "jyycode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/jyycode.git")).toEqual({ owner: "sst", repo: "jyycode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/jyycode")).toEqual({ owner: "sst", repo: "jyycode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/jyycode.git")).toEqual({ owner: "sst", repo: "jyycode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/jyycode")).toEqual({ owner: "sst", repo: "jyycode" })
})
