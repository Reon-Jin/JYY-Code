  ...
  scout.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const cache = path.join(Global.Path.repos, "github.com", "jyycode-glob-reference", "repo")
        ...
        const remoteDir = path.join(remoteRoot, "jyycode-glob-reference")
      ...
      }),
    {
      config: {
        reference: {
          docs: "jyycode-glob-reference/repo",
        },
      },
    },
  )
