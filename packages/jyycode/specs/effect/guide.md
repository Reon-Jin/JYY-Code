...
How we write Effect code in `packages/jyycode`. The companion roadmap is
[`todo.md`](./todo.md).
...
export class Service extends Context.Service<Service, Interface>()("@jyycode/Foo") {}
...
Read jyycode runtime flags through
