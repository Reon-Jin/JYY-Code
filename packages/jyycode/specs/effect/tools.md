...
Practical reference for the current tool-migration state in `packages/jyycode`.
...
Tool tests should use the existing Effect helpers in `packages/jyycode/test/lib/effect.ts`:
