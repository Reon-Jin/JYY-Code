...
const disabled = process.env["JYYCODE_DISABLE_SHARE"] === "true" || process.env["JYYCODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@jyycode/ShareNext") {}
