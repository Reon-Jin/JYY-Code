 ...
 *   "@jyycode/ServerAuthConfig",
 *   {
 *     password: Config.string("JYYCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("JYYCODE_SERVER_USERNAME").pipe(Config.withDefault("jyycode")),
 *   },
 * ) {}
 *
