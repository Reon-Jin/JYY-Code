import type { JsonSchema, LLMRequest, ProviderMetadata } from "@jyycode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@jyycode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @jyycode-ai/llm request objects from jyycode's session/AI SDK-shaped data.
  return LLM.request({
