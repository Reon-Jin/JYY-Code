import { Slug } from "@jyycode-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@jyycode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@jyycode/Session") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const setMultiAgent = Effect.fn("Session.setMultiAgent")(function* (input: {
      sessionID: SessionID
      enabled: boolean
    }) {
