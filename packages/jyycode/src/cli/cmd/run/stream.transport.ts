...
import type { Event, GlobalEvent, JyycodeClient } from "@jyycode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@jyycode/RunStreamTransport") {}
