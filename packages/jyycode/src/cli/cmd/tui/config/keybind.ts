...
export const Definitions = {
  ...
  session_toggle_multi_agent: keybind("f9", "Toggle Multi-Agent mode for the next prompt"),
  session_toggle_deferred_tools: keybind("f10", "Toggle deferred tools for the next prompt"),
  ...
  session_email_view: keybind("ctrl+right", "Switch to the email processing session"),
  session_email_back: keybind("ctrl+left", "Switch back from the email processing session"),
  ...
  "dialog.tools.toggle": keybind("space", "Toggle direct tool disclosure"),
...
export const CommandMap = {
  ...
  session_toggle_multi_agent: "session.toggle.multi_agent",
  session_toggle_deferred_tools: "session.toggle.deferred_tools",
  ...
  session_email_view: "session.email.view",
  session_email_back: "session.email.back",
