...
import { useBindings, useCommandSlashes, useJyycodeModeStack } from "../../keymap"
...
export function Autocomplete(props: {
  ...
  const modeStack = useJyycodeModeStack()
  ...
  function referencePromptText(reference: Reference.Resolved) {
    ...
    return [
      ...
      ...(problem
        ? [`Problem: ${problem}`]
        : [
            "For targeted context, inspect the reference path directly with Read, Glob, and Grep. For broader research, delegate to a subagent and include this reference path.",
          ]),
    ].join("\n")
  }
