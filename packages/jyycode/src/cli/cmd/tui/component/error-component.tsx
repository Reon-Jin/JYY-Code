...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/anomalyco/jyycode/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("jyycode-version", InstallationVersion)
