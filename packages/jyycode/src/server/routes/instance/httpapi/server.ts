...
import { fileMediaRoute } from "./handlers/file-media"
...
const rawInstanceRoutes = Layer.mergeAll(ptyConnectRoute, fileMediaRoute).pipe(Layer.provide(instanceRouterLayer))
