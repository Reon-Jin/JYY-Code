...
>()("@jyycode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@jyycode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.JYYCODE_WORKSPACE_ID ? WorkspaceID.make(Flag.JYYCODE_WORKSPACE_ID) : undefined
}
