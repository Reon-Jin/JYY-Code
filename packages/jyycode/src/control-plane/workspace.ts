...
export class Service extends Context.Service<Service, Interface>()("@jyycode/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        JYYCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        JYYCODE_WORKSPACE_ID: config.id,
        JYYCODE_EXPERIMENTAL_WORKSPACES: "true",
