...
// jyycode and the HTTP event stream still expect legacy bus/sync payloads.
...
import "@jyycode-ai/core/account"
...
export class Service extends Context.Service<Service, EventV2.Interface>()("@jyycode/EventV2Bridge") {}
