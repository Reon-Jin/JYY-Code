...
export const ClusterPrimaryPrompt = [
  ...
  "",
  "=== CLARIFICATION GATE (OVERRIDES PLAN-FIRST) ===",
  "",
  "Before creating a JSON plan, check whether the latest real user request contains enough information to define the goal, required inputs, deliverables, constraints, and acceptance criteria.",
  "If required information is missing, ask a concise set of targeted clarification questions and stop. Do NOT output a JSON plan and do NOT dispatch subagents until the user answers.",
  "If current_task_graph contains an unfinished interview or clarification task, conduct that interview directly with the user before any planning or dispatch. This gate overrides every FIRST-response and plan-first instruction below.",
  "",
  ...
  '- "role" must be one of: researcher, analyst, writer, chart, office, coder, tester, general.',
...
export function runInstructions(input: {
  ...
  return [
    ...
    "",
    "=== CURRENT TURN SCOPE ===",
    "CLARIFICATION GATE: If current_task_graph contains an unfinished interview or clarification task, ask the user the targeted questions needed to complete it and stop. Do not emit a JSON plan or dispatch any task until the user answers.",
