...
def configure_console_encoding() -> None:
    """Avoid legacy Windows console encoding failures for diagnostic output."""
...
class PDFToImagesConverter:
    ...
    def convert(self) -> List[Path]:
        ...
        if HAS_PYMUPDF:
            ...
            raise RuntimeError(
                "PyMuPDF is unavailable in the current runtime. Use an already configured "
                "Python environment that provides PyMuPDF, or report that image conversion "
...
Requirements:
  PyMuPDF must already be available in the selected Python runtime.
        """
    )
