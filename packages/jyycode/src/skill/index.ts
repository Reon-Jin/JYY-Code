...
// jyycode.json should look like is often wrong, and jyycode hard-fails on
// invalid config, so users hit cryptic startup errors. Loading this skill
// when the model is asked to touch jyycode's own config files gives it the
// actual schemas instead of guesses.
const CUSTOMIZE_JYYCODE_SKILL_NAME = "customize-jyycode"
...
export class Service extends Context.Service<Service, Interface>()("@jyycode/Skill") {}
