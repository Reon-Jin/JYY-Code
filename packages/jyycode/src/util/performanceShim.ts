 ...
 * can reclaim.
 *
 * Ported from claudecode's src/utils/performanceShim.ts.
 * MUST be imported before any other modules that use performance marks.
 */
...
const shim = {
  now,
  mark,
  measure: measureFn as typeof performance.measure,
  ...
  clearResourceTimings: noop as typeof performance.clearResourceTimings,
  setResourceTimingBufferSize: noop as typeof performance.setResourceTimingBufferSize,
