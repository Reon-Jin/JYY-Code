...
type Plugin = {
  id: PluginV2.ID
  effect: PluginV2.Effect<Catalog.Service | AgentV2.Service | Npm.Service | EventV2.Service | PluginV2.Service>
}
...
export class Service extends Context.Service<Service, Interface>()("@jyycode/v2/PluginBoot") {}
