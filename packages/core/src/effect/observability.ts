...
import { ensureProcessMetadata } from "../util/jyycode-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    ...
    attributes: {
      ...
      "jyycode.client": Flag.JYYCODE_CLIENT,
      "jyycode.process_role": processMetadata.processRole,
      "jyycode.run_id": processMetadata.runID,
