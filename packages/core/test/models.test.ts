...
// test/preload.ts pins JYYCODE_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.JYYCODE_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.JYYCODE_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.JYYCODE_MODELS_PATH = undefined
  Flag.JYYCODE_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.JYYCODE_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.JYYCODE_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
