...
Schema-first LLM core for jyycode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@jyycode-ai/llm"
import { OpenAI } from "@jyycode-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@jyycode-ai/llm/providers"
