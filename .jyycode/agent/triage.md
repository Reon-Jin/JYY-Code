...
Desktop application and browser-based app issues, including `jyycode web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core jyycode server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

JYYCode Zen, JYYCode Go, and billing issues.
