...
Use this folder for locale-specific translation guidance that supplements `.jyycode/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/jyycode/pull/12345

## Do Not Translate (Locale Additions)

- `JYYCode` (preserve casing)
