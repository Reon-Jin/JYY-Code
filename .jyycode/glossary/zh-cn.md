...
- PR #13942: https://github.com/anomalyco/jyycode/pull/13942

## Do Not Translate (Locale Additions)

- `JYYCode` (preserve casing in prose; keep `jyycode` only when it is part of commands, package names, paths, or code)
- `JYYCode Zen`
- `JYYCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `jyycode` in prose when referring to the product name; use `JYYCode`
