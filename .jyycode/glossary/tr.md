...
- PR #15835: https://github.com/anomalyco/jyycode/pull/15835

## Do Not Translate (Locale Additions)

- `JYYCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `jyycode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `JYYCode` in prose, `jyycode` only for exact technical identifiers
...
- Avoid changing `jyycode` to `JYYCode` inside commands, URLs, package names, or code literals
