...
- PR #10809: https://github.com/anomalyco/jyycode/pull/10809
- PR #11496: https://github.com/anomalyco/jyycode/pull/11496

## Do Not Translate (Locale Additions)

- `JYYCode` (preserve casing in prose; keep `jyycode` only in commands, package names, paths, or code)
- `JYYCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
